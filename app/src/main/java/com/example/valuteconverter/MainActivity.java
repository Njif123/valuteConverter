...
public class MainActivity extends AppCompatActivity {
    ...
    ValuteModelAdapter valuteModelAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valuteModelAdapter = new ValuteModelAdapter(valuteModelList, this);
                ...
                call.enqueue(new Callback<Example>() {
                    ...
                    public void onResponse(Call<Example> call, Response<Example> response) {
                        if(!response.isSuccessful()) {
                            testText.setText(response.code()+"");
                            return;
                        }
                        ...
                        Log.d("check", valuteModelList.get(1).getValue()+" "+valuteModelList.size());

                        testText.setText(valuteModelList.size()+"");
                        valuteModelAdapter = new ValuteModelAdapter(valuteModelList,getApplicationContext());
                        valuteModelAdapter.setData(valuteModelList);
                        recyclerView.setAdapter(valuteModelAdapter);
